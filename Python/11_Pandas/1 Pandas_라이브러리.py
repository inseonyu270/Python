...
# pandas : 어디에 쓰이냐? AI, 머신러닝(ML, 인공지능), 딥러닝, 그래프를 뽑아내기 위해
...
# 데이터가 없는 경우. numpy를 임포트 한 후 np.nan으로 데이터가 없음을 표시 할 수 있다.
import numpy as np
...
# Series 데이터를 생성할 떄 다음과 같이 인자로 index 추가 가능.
...
index_data = ['2024-10-23', '2024-10-24', '2024-10-25', '2024-10-26']
...
# pandas에는 데이터의 통계 분석을 위한 메서드(함수:호출)이 있어서 데이터의 총합, 평균, 편차 등을 쉽게 구할 수 있음.
# 2012년부터 2016년까지 우리나라의 계절별 강수량(단위 mm)


table_data3 = {'봄' : [256.6, 264.3, 215.9, 223.2, 312.8],
               '여름' : [770.6, 567.5, 599.8, 387.1, 446.2],
               '가을' : [363.5, 231.2, 293.1, 247.7, 381.6],
               '겨울' : [139.3, 59.9, 76.9, 109.1, 108.1]}

colummn_list = ['봄', '여름', '가을', '겨울']
